    ...
    public partial class FrmMain : Form
    {
        ...
        private void btn_Start_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int rowIDX = 0; rowIDX < l_getDataRow.Length; rowIDX++)
                {
                    ...
                    l_tempAML = l_tempAML.Replace("$1", l_getDataColumn[0]);
                    l_tempAML = l_tempAML.Replace("$2", l_getDataColumn[4]);
                    l_tempAML = l_tempAML.Replace("$3", l_getDataColumn[5]);
                    l_tempAML = l_tempAML.Replace("$4", l_getDataColumn[1]);
        ...
        private void btn_StartReplace_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult result = MessageBox.Show("Replace Main Body Fabric Just Change Appoint Version And Generation, Do You Know That ?", "System Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
